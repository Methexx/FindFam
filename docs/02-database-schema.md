...
| contact_user_id | uuid, FK → users.id, **not null** | must be an existing FindFam user — free-tier MVP requires SOS contacts to be app users, see 00-master-project-reference.md cost/scope decision |
