...
import { Map, Users, UserPlus, LogOut, ShieldCheck } from 'lucide-react';
import { cn } from '@/lib/utils';
import { GlowBackdrop } from '@/components/ui/glow-backdrop';

// Mirrors app/dashboard/layout.tsx rather than inventing a second shell —
// same glass sidebar, same active-link treatment. The two surfaces are
// separate sessions, not separate products, and should look like it.
const NAV_ITEMS = [
  ...
  return (
    <div className="relative flex min-h-screen overflow-hidden">
      ...
      <aside className="flex w-56 flex-col border-r border-glass-border bg-glass px-3 py-6 backdrop-blur-xl">
        <Link href="/" className="mb-8 flex items-center gap-2 px-3 text-lg font-semibold tracking-tight">
